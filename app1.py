...
colegiados = [
    ...
    },
    {
        ...
        "detalhes": {
            ...
            "Composição": "3 membros (1 Presidente: SEDES); 2 (1 Vice: SEFAZ); 1 (SEAPPA); 1 minoritário; 1 independente",
            "Convocação": "Pelo Presidente ou por dois conselheiros, com antecedência mínima de 5 dias",
            "Presidência": "Representante da SEDES e vice da SECC (inciso I, art. 34 - ES)",
    ...
    },
    {
        ...
        "membros": ["Gabriel Mac-Dowell Blum (Presidente)", "Francisco Pereira Iglesias", "Vago (SEDES)"],
        "processo": "SEI-220010/000165/2023",
        "detalhes": {
            "Natureza": "Órgão permanente de fiscalização",
            "Composição": "2 efetivos + suplentes (1 da SEFAZ); 1 efetivo + suplente (SEDES); 1 efetivo + suplente (acionistas minoritários)",
